    ...
    return(
        <div className="movie-main-page">
                ...
                <div className="movie-movie-cards-container" id="movie-movie-cards-container">
                    <div className="card1-container-movie"><Link className="movie-link" to='/lordoftherings-movie'><Card1 MovieName={LordOfTheRings.MovieName} imgUrl={LordOfTheRings.imgUrl} Desc={LordOfTheRings.Desc} IMDB={LordOfTheRings.IMDB}/></Link></div>
