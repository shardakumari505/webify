...
export const Inception = {
    ...
    IMDB:"8.8",
    Cast:"Leonardo DiCaprio  •  Ken Watanabe  •  Joseph Gordon-Levitt  •  Marion Cotillard  •  Elliot Page[a]  •  Tom Hardy  •  Cillian Murphy   Tom Berenger   Michael Caine",
    Director:"Christopher Nolan",
    ReleaseYear:"2010",
    Duration:"2h 28m",
    Genre : "Action",
...
export const SpiderMan = {
    ...
    Desc:"It is the first animated film in the Spider-Man franchise. The film's story follows Miles Morales as he becomes the new Spider-Man and joins other Spider-People from various parallel universes to save his universe from Kingpin.",
    IMDB:"8.4",
...
export const LivesofOthers = {
    MovieName:"The Lives of the Others",
...
export const MirrorGame = {
    MovieName:"Mirror Game",
    ...
    IMDB:"9.0",
    Cast:"Parvin Dabas  •  Dhruv Bali  •  Pooja Batra  •  Omi Vaidya",
...
export const Chhichhore = {
    ...
    IMDB:"8.3",
    Cast:"Sushant Singh Rajput  •  Shraddha Kapoor  •  Varun Sharma  •  Naveen Polishetty  •  Tushar Pandey  •  Tahir Raj Bhasin  •  Prateik Babbar  •  Shishir Sharma  •  Mohammad Samad",
